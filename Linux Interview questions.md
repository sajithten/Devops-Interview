...
3. What is Swap Space?4.  What is the maximum length for a file name in Linux?
...
8. What are the file permissions in Linux?9.  more questions are from sed, find and awk .
...
19. What are the fields in the/etc/passwd file?20.  How do you terminate an ongoing process?
